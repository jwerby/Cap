				...
				<Body className="mx-auto my-auto bg-gray-1 font-sans">
					<Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
						...
						<Text className="text-sm leading-6 text-black mt-6">
							With {PORTSTBD_BRAND.companyName}, you can share recordings,
							collect feedback, and collaborate from one secure watch page.
						</Text>
						<Footer email={email} marketing={marketing} />
					</Container>
				</Body>
			</Tailwind>
		</Html>
