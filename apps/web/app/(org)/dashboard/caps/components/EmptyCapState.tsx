...
export const EmptyCapState: React.FC<EmptyCapStateProps> = ({ userName }) => {
	...
	return (
		<div className="flex flex-col flex-1 justify-center items-center w-full h-full">
			<div className="flex flex-col gap-3 justify-center items-center h-full text-center rounded-[28px] border border-[#D8E7EB] bg-white/55 px-6 py-10 shadow-[0_28px_80px_-60px_#163760] dark:border-gray-4 dark:bg-gray-2">
				...
				<div className="flex flex-col items-center px-5">
					<p className="mb-1 text-xl font-bold text-[#163760] dark:text-gray-12">
