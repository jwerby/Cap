...
import { PortstbdLogo } from "@/components/PortstbdAuthLogo";
		...
		<>
			...
			<div className="flex items-center justify-between pb-[0.25rem]">
				<div className="flex items-center space-x-1">
					<PortstbdLogo className="h-7 w-auto max-w-[160px]" />
					<svg
						className="hidden"
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
						viewBox="0 0 103 40"
						aria-label="Port & Starboard Logo"
					>
						<title>Port & Starboard Logo</title>
						<rect
							width="39.5"
							height="39.5"
							x="0.25"
